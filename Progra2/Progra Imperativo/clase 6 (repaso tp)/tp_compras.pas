 ...
 if (a <> nil) then begin
  if (a^.cod > p) then begin
   if (a^.cod < f) then  begin
     writeln ('El total de dinero del cod ',a^.cod, ' es de: ',a^.recaudado:0:2);                           // el primer numero no sirve(ponemos en 0) y el segundo indica la cantidad de digitos que quiero despues del 0
     reco_arbol (a^.HI);
     reco_arbol (a^.HI);
     reco_arbol (a^.HD);
     end
