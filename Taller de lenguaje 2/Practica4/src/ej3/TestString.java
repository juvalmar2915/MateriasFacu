...
//2. la concatenacion de string lo que hace es crear un nuevo objeto cada vez que se llama el metodo ya que es no mutable,
// con el stringbuffer al ser de caracter mutable no es necesario crear un objeto por lo cual para concatenar se modifica directamente.
// El stringBuilder tiene el mismo caracter que el stringBuffer pero la diferencia es que este es mas eficiente ya que es asincronico por lo que cada llamada puede hacerse en conjunto mientras el buffer es sincronico